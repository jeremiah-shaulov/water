...
```ts
import {RdStream, Source} from 'https://deno.land/x/water@v1.0.15/mod.ts';
import {WrStream, Sink} from 'https://deno.land/x/water@v1.0.15/mod.ts';
import {TrStream, Transformer} from 'https://deno.land/x/water@v1.0.15/mod.ts';
import {TooBigError} from 'https://deno.land/x/water@v1.0.15/mod.ts';
```
...
```ts
import {RdStream} from 'https://deno.land/x/water@v1.0.15/mod.ts';
...
```ts
import {WrStream} from 'https://deno.land/x/water@v1.0.15/mod.ts';
...
```ts
import {RdStream, TrStream} from 'https://deno.land/x/water@v1.0.15/mod.ts';
...
```ts
import {RdStream, WrStream, TrStream} from 'https://deno.land/x/water@v1.0.15/mod.ts';
